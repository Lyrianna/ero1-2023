...
def main():
    ...
    initial_graph = graph_adj_mat.GraphAdjMat(mat=mat)
    ...
    print('graph degree =', initial_graph.degree)
    print(initial_graph)
    # graph_initial.to_dot(filename='initial_graph')

    final_path = solver.solve(initial_graph)
    print('path of lenngth =', len(final_path))
    print('path =', final_path)

    graph_rendering.render_path_as_gif(initial_graph.edge_list(), final_path)
